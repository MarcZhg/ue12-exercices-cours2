...
# %%
def create_ones():
    return create_zeros() + 1  # 👈 Insérez le code ici
...
# %%
def create_random():
    return np.random.randint(0,2,size = (3,3))  # 👈 Insérez le code ici
...
# %%
def sin_values():
    tab = np.arange(0,2*np.pi+0.1,0.1)
